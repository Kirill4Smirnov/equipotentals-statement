...
For making a significant amount of experiments this method is time-consuming, so we robotized the measuring process. We used a biaxial manipulator, that can move the voltmeter probe and write the measure value and coordinates of the probe to a file on a computer. 	. Manipulator characteristics:
\begin{enumerate}
...
\hfill
\begin{minipage}[h]{0.47\linewidth}
\center{\includegraphics[width=0.9\linewidth]{0.5g.pdf}}
%\caption{Photo of the biaxical manipulator} %% подпись к рисунку
%\label{fig:mesh2} %% метка рисунка для ссылки на него
\end{minipage}
\end{center}
...
\begin{figure}[htb!]
\begin{center}
\center{\includegraphics[width=0.7\linewidth]{2.0_g_VAC2.pdf}}
\end{center}
