...
\caption{Normed error of figure \ref{fig:mesh4} expirement}
\label{fig:dif6}
\end{minipage}
\hfill
\begin{minipage}[h]{0.47\linewidth}
\center{\includegraphics[width=1\linewidth]{difSol2Norm.pdf}}
\caption{Normed error of figure \ref{fig:mesh5} expirement}
\label{fig:dif2}
\end{minipage}
...
We are thankfull to Artem D. Sukhov for help with writing the article and Ivan Kolesnikov for providing the nessesary support with theory. We are also grateful to Pavel A. Kotin for providing the necessary conditions for the research. \cite{khaparde}
